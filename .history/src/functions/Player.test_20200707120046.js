...
test("attack enemy", () => {
  ...
  computerBoard.placeShip(0, 0, player.ships[0], 1);
  computerBoard.placeShip(1, 0, player.ships[1], 1);
  computerBoard.placeShip(2, 0, player.ships[2], 1);
  computerBoard.placeShip(3, 0, player.ships[3], 1);
  computerBoard.placeShip(4, 0, player.ships[4], 1);
});
