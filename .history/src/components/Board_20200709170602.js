...
const Board = () => {
  ...
  const computerPlaceShips = () => {
    ...
    let battleship = computerBoard.placeShip(4, 2, computer.ships[1], 0);
    let cruiser = computerBoard.placeShip(0, 3, computer.ships[2], 0);
    let submarine = computerBoard.placeShip(3, 5, computer.ships[3], 0);
    let destoryer = computerBoard.placeShip(0, 7, computer.ships[4], 0);
