...
const Board = () => {
  ...
  const startGame = () => {
    ...
    computerBoard.placeShip(0, 0, player.computer[0], 0);
    computerBoard.placeShip(0, 0, player.computer[1], 0);
    computerBoard.placeShip(0, 0, player.computer[2], 0);
    computerBoard.placeShip(0, 0, player.computer[3], 0);
    computerBoard.placeShip(0, 0, player.computer[4], 0);
  };
