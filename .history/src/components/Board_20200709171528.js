...
const Board = () => {
  ...
  const computerPlaceShips = () => {
    ...
    let cruiser = computerBoard.placeShip(4, 4, computer.ships[2], 0);
    let submarine = computerBoard.placeShip(0, 4, computer.ships[3], 1);
    let destoryer = computerBoard.placeShip(5, 6, computer.ships[4], 0);
