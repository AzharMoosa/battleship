...
const Board = () => {
  ...
  const startGame = () => {
    ...
    computerBoard.placeShip(0, 0, computer.ships[1], 0);
    computerBoard.placeShip(0, 0, computer.ships[2], 0);
    computerBoard.placeShip(0, 0, computer.ships[3], 0);
    computerBoard.placeShip(0, 0, computer.ships[4], 0);
  };
