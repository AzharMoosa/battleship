...
const Board = () => {
  ...
  const startGame = () => {
    ...
    playerBoard.placeShip(0, 3, player.ships[2], 0);
    playerBoard.placeShip(0, 5, player.ships[3], 0);
    playerBoard.placeShip(5, 4, player.ships[4], 0);

    computerBoard.placeShip(0, 0, computer.ships[0], 1);
    computerBoard.placeShip(1, 0, computer.ships[1], 1);
    computerBoard.placeShip(3, 0, computer.ships[2], 1);
    computerBoard.placeShip(5, 0, computer.ships[3], 1);
    computerBoard.placeShip(7, 0, computer.ships[4], 1);
  };
