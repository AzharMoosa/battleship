...
const Board = () => {
  ...
  const startGame = () => {
    ...
    playerBoard.placeShip(0, 2, player.ships[1], 0);
    playerBoard.placeShip(0, 4, player.ships[2], 0);
    playerBoard.placeShip(0, 6, player.ships[3], 0);
    playerBoard.placeShip(0, 8, player.ships[4], 0);
